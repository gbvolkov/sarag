...
from retrievers.utils.load_table import get_data_from_json, get_glossary_data
from retrievers.utils.build_documents import (
...
class TeamlyAPIWrapper(BaseModel, ABC):
    ...
    def _load_sd_documents(self):
        if config.RETRIEVER_TYPE == "teamly" and os.path.exists(self.articles_json_path):
